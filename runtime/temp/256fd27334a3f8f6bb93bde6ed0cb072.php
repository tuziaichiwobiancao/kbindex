<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpstudy_pro\oldindex\public/../application/admin\command\Install\install.html";i:1704603673;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="container">
    ...
    <h4><button onclick="gourl()">自助购买授权</button></h4>
    <div>请在php配置文件中最后一行加入:<br/><font color="red">extension = <?php echo $_SERVER['DOCUMENT_ROOT']."/swoole_loader.so"?></font></div>
    <div>
        ...
        <form method="post">
            ...
            <div class="form-group">
                <div class="form-field">
                    <label>授权码</label>
                    <input name="licenses" value="" required=""/>
                </div>
        ...
        <script>
            ...
            function gourl(){
                window.location.href = "https://faka.oo-uu.cc";
            }
        </script>
    </div>
</div>
